...
export type EditPartyFieldsFragment = { __typename?: 'identity_parties', party_id: number, first_name: string, last_name: string, idp_id: string, party_roles: Array<{ __typename?: 'identity_party_roles', role_type: { __typename?: 'identity_role_type', description: string } }> } & { ' $fragmentName'?: 'EditPartyFieldsFragment' };
